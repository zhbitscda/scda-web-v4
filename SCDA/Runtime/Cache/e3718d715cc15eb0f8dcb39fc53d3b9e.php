...
<div class="container" style="margin-top:10%;">
	...
	<div class="introduce">
    	...
    	<div class="introduce_title">
        	<div class="title_img">
            	<div class="img-box">
                    <img alt="" src="__PUBLIC__/images/zuchitop.jpg">
            ...
            <div class="title_box">
            	<h4>主持组 部门介绍</h4>
                <h5 style="color:#318CBD">首页-关于我们-主持组</h5>
                <h5 style="color:#A2A2A2">发布时间：2015/9/23</h5>
            </div>
        </div>
        
        <div class="introduce_content">
        	<p> 主要负责协会各项活动主持，在各项协会品牌活动中通过现场主持的带动扩大现场观众的视与听美的感受。我们是协会形象及礼仪的美丽担当，各职场和社交礼仪的培训更会让每个小朋友外修身内养性，美丽大方的姿态，优雅得体谈吐见证着我们美丽的蜕变。机智与沉稳是你在这里的成长与改变，温馨和谐的家氛围更是你在北理工不可错过的选择。</p>
            <img alt="" src="__PUBLIC__/images/zc01.jpg">
            <h4>部门合照</h4>
            <img alt="" src="__PUBLIC__/images/zc02.jpg">
      </div>
