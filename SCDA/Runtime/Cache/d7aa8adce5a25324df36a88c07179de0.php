...
<div class="container" style="margin-top:10%;">
	...
	<div class="introduce">
    	...
    	<div class="introduce_title">
        	<div class="title_img">
            	<div class="img-box">
                    <img alt="" src="__PUBLIC__/images/zhiguitop.jpg">
            ...
            <div class="title_box">
            	<h4>职业规划部 部门介绍</h4>
                <h5 style="color:#318CBD">首页-关于我们-职业规划部</h5>
                <h5 style="color:#A2A2A2">发布时间：2015/9/23</h5>
            </div>
        </div>
        
        <div class="introduce_content">
        	<p> 职协大脑，主要负责职协大型活动策划以及文案撰写。比起规规矩矩，我们更喜欢脑洞大开。我们是活动的发起者，渴望把充满活力的创意运用在活动中，并引导品牌活动的走向；我们是专业的策划者，用严谨的思维和负责的态度致力于每场活动的策划，创造一切可能；我们是"家"文化的传播者，通过部门策划的惊喜活动，给你们一个五星级的家！</p>
            <img alt="" src="__PUBLIC__/images/zg01.jpg">
            <h4>部门合照</h4>
            <img alt="" src="__PUBLIC__/images/zg02.jpg">
      </div>
