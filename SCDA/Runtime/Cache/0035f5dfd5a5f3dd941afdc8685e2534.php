...
<div class="container" style="margin-top:10%;">
	...
	<div class="introduce">
    	...
    	<div class="introduce_title">
        	<div class="title_img">
            	<div class="img-box">
                    <img alt="" src="__PUBLIC__/images/gongguantop.jpg">
            ...
            <div class="title_box">
            	<h4>市场公关部 部门介绍</h4>
                <h5 style="color:#318CBD">首页-关于我们-市场公关部</h5>
                <h5 style="color:#A2A2A2">发布时间：2015/9/23</h5>
            </div>
        </div>
        
        <div class="introduce_content">
        	<p> 作为高校与社会的沟通纽带，肩负内外交流，为活动项目筹集资金资源的重任。作为学校唯一制作调研报告的部门，我们走在调研数据化，专业化的前沿。我们着重于职场技巧、交际沟通和专业技能的塑造与提升。情感与传承是我们的主线，我们高效认真，品牌活动、项目会议、出游聚会……不怕你没经历，就怕你没勇气。我们虚位以待，职等你来。</p>
            <img alt="" src="__PUBLIC__/images/sg01.jpg">
            <h4>部门合照</h4>
            <img alt="" src="__PUBLIC__/images/sg02.jpg">
      </div>
