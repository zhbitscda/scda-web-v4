...
<div class="container" style="margin-top:10%;">
	...
	<div class="introduce">
    	<div class="introduce_title">
        	<div class="title_img">
            	<div class="img-box">
                    <img alt="" src="__PUBLIC__/images/xuanchuantop.jpg">
            ...
            <div class="title_box">
            	<h4>宣传部 部门介绍</h4>
                <h5 style="color:#318CBD">首页-关于我们-宣传部</h5>
                <h5 style="color:#A2A2A2">发布时间：2015/9/23</h5>
            </div>
        </div>
        
        <div class="introduce_content">
        	<p> 主要负责协会的各项宣传工作，包括海报横幅等宣传栏设计、手工品制作、书法及美工等。我们有无拘无束的想象力，一直领先的设计以及海量的作品展示机会。在这里，你可以学会用镜头定格美丽的画面；在这里，你可以用CorelDraw、Photoshop做高逼格设计，各种平面宣传信手拈来；在这里，你可以结识众多独具匠心的设计者，不同的创作思维激烈碰撞。</p>
            <img alt="" src="__PUBLIC__/images/xc01.jpg">
            <h4>部门合照</h4>
            <img alt="" src="__PUBLIC__/images/xc02.jpg">
      </div>
