...
<div class="container" style="margin-top:10%;">
	...
	<div class="introduce">
    	...
    	<div class="introduce_title">
        	<div class="title_img">
            	<div class="img-box">
                    <img alt="" src="__PUBLIC__/images/chuanmeitop.jpg">
            ...
            <div class="title_box">
            	<h4>传媒部 部门介绍</h4>
                <h5 style="color:#318CBD">首页-关于我们-传媒部</h5>
                <h5 style="color:#A2A2A2">发布时间：2015/9/23</h5>
            </div>
        </div>
        
        <div class="introduce_content">
        	<p> 职协的窗口， 主要负责职协官方微博和微信公众号的运营管理，各个活动的拍摄摄影及视频的剪辑与后期制作及网站等。我们利用多种方式对外推广职协每个活动，其中包括微博、贴吧、微信公众平台的线上推广等。我们用精彩的文字报道一线的新闻动态，用酷炫的Adobe premiere、Adobe AfterEffect 制作视频大片。文字，是呈现精彩活动的载体；镜头，是记录精彩瞬间的眼睛。</p>
            <img alt="" src="__PUBLIC__/images/cm02.jpg">
            <h4>部门合照</h4>
            <img alt="" src="__PUBLIC__/images/cm01.jpg">
      </div>
